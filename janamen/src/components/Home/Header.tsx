    ...
    <div className="container mx-auto px-20">
      <div className="flex self-center justify-center inset-x-0 lg:mx-0 mx-3 py-12">
        <nav className="relative w-full px-4 py-6 flex items-center rounded-xl">
          ...
          <ul className="hidden lg:flex lg:items-center lg:space-x-12 gap-4 ml-8">
            <li><Link className="text-lg font-light text-white hover:text-gray-500" href="#AboutUs" onClick={closeMenu}>JANAMEN</Link></li>
            <li><Link className="text-lg font-light text-white hover:text-gray-500" href="https://teethalignpartners.kz/">TARTYL FEST</Link></li>
            <li><Link className="text-lg font-light text-white hover:text-gray-500" href="#Contacts" onClick={closeMenu}>{t('header.biography')}</Link></li>
          </ul>
